...
for(i=0; i < encomenda_cliente.length; i++) {
     ...
     if (tab_qtd < 1 || isNaN(tab_qtd)) {
          ...
          clientes.children[2].style.backgroundColor = "red";
          clientes.children[2].style.color = "white"
     } else {
          clientes.children[4].textContent = calculaTotal(tab_qtd, tab_unitario)
           ...
           clientes.children[3].style.backgroundColor = "white";
           clientes.children[3].style.color = "red";
     } else {
          clientes.children[4].textContent = calculaTotal(tab_qtd,tab_unitario)
